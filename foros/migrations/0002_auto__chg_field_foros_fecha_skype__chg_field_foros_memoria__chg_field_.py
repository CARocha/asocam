...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Foros.fecha_skype'
        db.alter_column('foros_foros', 'fecha_skype', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Foros.memoria'
        db.alter_column('foros_foros', 'memoria', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Foros.cierre'
        db.alter_column('foros_foros', 'cierre', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Foros.apertura'
        db.alter_column('foros_foros', 'apertura', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Foros.fecha_skype'
        db.alter_column('foros_foros', 'fecha_skype', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Foros.memoria'
        db.alter_column('foros_foros', 'memoria', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Foros.cierre'
        db.alter_column('foros_foros', 'cierre', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Foros.apertura'
        db.alter_column('foros_foros', 'apertura', self.gf('django.db.models.fields.DateField')(default=None))
    ...
    models = {
        ...
        'foros.aportes': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
        ...
        'foros.foros': {
            ...
            'apertura': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'cierre': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'contenido': ('ckeditor.fields.RichTextField', [], {}),
            'contraparte': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'creacion': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)'}),
            'fecha_skype': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memoria': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
