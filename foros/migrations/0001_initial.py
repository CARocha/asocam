...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('foros_foros', (
            ...
            ('creacion', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 10, 0, 0))),
    ...
    models = {
        ...
        'foros.foros': {
            ...
            'creacion': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 10, 0, 0)'}),
