...
def notify_all_foro(foros):
    ...
    send_mail('Nuevo Foro en ASOCAM', contenido, 'asocam@asocam.org', [user.email for user in users if user.email])
...
def notify_all_aporte(aportes):
    ...
    send_mail('Nuevo Aporte en ASOCAM', contenido, 'asocam@asocam.org', [user.email for user in users if user.email])
...
def notify_user_comentario(comentario):
    ...
    send_mail('Nuevo comentario ASOCAM', contenido, 'asocam@asocam.org', [comentario.aporte.user.email])
