...
class Foros(models.Model):
    ...
    apertura = models.DateField('Apertura y recepción de aportes', null=True, blank=True)
    cierre = models.DateField('Cierre de aportes', null=True, blank=True)
    fecha_skype = models.DateField('Propuesta de reunión skype', null=True, blank=True)
    memoria = models.DateField('Propuesta entrega de memoria', null=True, blank=True)
