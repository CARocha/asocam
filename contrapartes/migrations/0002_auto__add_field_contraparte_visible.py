...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contraparte.visible'
        db.add_column('contrapartes_contraparte', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contraparte.visible'
        db.delete_column('contrapartes_contraparte', 'visible')
    ...
    models = {
        ...
        'contrapartes.mensajero': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
